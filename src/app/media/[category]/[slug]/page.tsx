...
const articleData: Record<string, Record<string, ArticleDetail>> = {
    "press-release": {
        "pain-free-mobility-cartilage-repair": {
            title: "Dhamma Superspeciality Hospital Restores Pain Free Mobility in 38 Year Old Woman Post Advanced Cartilage Repair Surgery",
            hospital: "Dhamma Superspeciality Hospital, Patna",
            date: "Jun 30, 2026",
        ...
        "bone-marrow-transplants-milestone": {
            title: "Dhamma Superspeciality Hospital Marks 2500 Bone Marrow Transplants Transforming Lives Through Advanced Blood Disorder Care",
            hospital: "Dhamma Superspeciality Hospital, Patna",
            date: "Jun 30, 2026",
            category: "press-release",
            categoryLabel: "Press Release",
            ...
            content: [
                "Bodhgaya, June 30, 2026: Dhamma Superspeciality Hospital has achieved a remarkable milestone of completing 2,500 bone marrow transplant procedures, making it one of the leading centers for hematological care in Eastern India. This achievement underscores the hospital's commitment to providing advanced medical treatments to patients across Bihar and neighboring states.",
        ...
        "rare-abdominal-angina-treatment": {
            ...
            image: "/images/media/media_1.png",
            content: [
                "Bodhgaya, June 29, 2026: In a complex medical intervention, doctors at Dhamma Superspeciality Hospital successfully treated a 42-year-old woman suffering from a rare condition known as abdominal angina — chronic abdominal pain caused by reduced blood flow to the intestines. The condition, if left untreated, can lead to intestinal gangrene and can be fatal.",
                "The patient had been experiencing severe post-meal abdominal pain, significant weight loss, and fear of eating for over eight months. She had visited multiple hospitals and was misdiagnosed with various gastrointestinal conditions before being referred to Dhamma Superspeciality Hospital.",
        ...
        "robotic-rectal-cancer-surgery": {
            ...
            image: "/images/media/media_2.png",
            content: [
                "Bodhgaya, June 24, 2026: A 55-year-old Australian patient traveled to Dhamma Superspeciality Hospital for specialized robotic rectal cancer surgery after an 18-month battle with the disease. The patient chose Dhamma after extensive research into hospitals offering advanced robotic surgical capabilities in the Asia-Pacific region.",
        ...
        "vabb-technique-breast-lumps": {
            title: "First in Bihar Dhamma Superspeciality Hospital Introduces Minimally Invasive VABB Technique for Scar Minimal Removal of Benign Breast Lumps",
            hospital: "Dhamma Superspeciality Hospital, Patna",
            date: "Jun 23, 2026",
            category: "press-release",
            categoryLabel: "Press Release",
            ...
            image: "/images/media/media_2.png",
            content: [
                "Bodhgaya, June 23, 2026: Dhamma Superspeciality Hospital has introduced the Vacuum-Assisted Breast Biopsy (VABB) technique for the first time in Bihar, offering women a minimally invasive option for the removal of benign breast lumps with minimal scarring.",
        ...
        "complex-spine-surgery": {
            title: "Dhamma Superspeciality Hospital Performs Successful Complex Spine Surgery on 72-Year-Old Patient Using Advanced Navigation Technology",
            hospital: "Dhamma Superspeciality Hospital, Patna",
            date: "Jun 20, 2026",
            category: "press-release",
            categoryLabel: "Press Release",
            ...
            image: "/images/media/media_1.png",
            content: [
                "Bodhgaya, June 20, 2026: The neurosurgery team at Dhamma Superspeciality Hospital performed a successful complex spine surgery on a 72-year-old patient using advanced intraoperative navigation technology. The patient had been bedridden for three months due to severe spinal stenosis and degenerative spondylolisthesis.",
        ...
        "free-health-camp-gaya": {
            title: "Dhamma Superspeciality Hospital Launches Free Health Camp for Rural Communities in Gaya District Covering 500+ Patients",
            hospital: "Dhamma Superspeciality Hospital, Patna",
            date: "Jun 18, 2026",
            category: "press-release",
            categoryLabel: "Press Release",
            ...
            image: "/images/media/media_2.png",
            content: [
                "Bodhgaya, June 18, 2026: Dhamma Superspeciality Hospital organized a comprehensive free health camp in Gaya district, providing medical screening, consultations, and basic diagnostic services to over 500 patients from rural communities. The camp was conducted across three locations over a span of two days.",
                "The health camp offered free consultations in general medicine, orthopedics, ophthalmology, cardiology, and gynecology. Additionally, free blood sugar, blood pressure, and basic blood tests were conducted for all attendees. Patients requiring further treatment were referred to Dhamma Superspeciality Hospital with subsidized treatment packages."
            ]
        },
        "child-congenital-heart-surgery": {
            ...
            image: "/images/media/media_1.png",
            content: [
                "Bodhgaya, June 15, 2026: The pediatric cardiac surgery team at Dhamma Superspeciality Hospital successfully operated on a 5-year-old child diagnosed with a rare congenital heart defect — Tetralogy of Fallot with pulmonary atresia. The child, from a farming family in Jehanabad district, had been cyanotic since birth and was unable to play or engage in normal childhood activities.",
        ...
        "knee-replacement-farmer": {
            ...
            image: "/images/media/media_2.png",
            content: [
                "Bodhgaya, June 12, 2026: A 65-year-old farmer from Aurangabad district has been able to walk pain-free after undergoing bilateral total knee replacement surgery at Dhamma Superspeciality Hospital. The patient had been suffering from severe osteoarthritis in both knees for over a decade.",
    ...
    "media-coverage": {
        "national-healthcare-excellence-awards": {
            title: "Dhamma Superspeciality Hospital Featured in National Healthcare Excellence Awards 2026",
            hospital: "Dhamma Superspeciality Hospital, Patna",
            date: "Jun 28, 2026",
        ...
        "toi-rural-healthcare-coverage": {
            ...
            image: "/images/media/media_2.png",
            content: [
                "The Times of India published a detailed feature on Dhamma Superspeciality Hospital's unique approach to delivering super-specialty healthcare in rural Bihar. The article highlighted how the hospital has successfully bridged the healthcare divide by combining advanced medical technology with community-centric care models."
            ]
        },
        "ndtv-healthcare-gap-feature": {
            title: "NDTV Health Feature: How Dhamma Superspeciality Hospital is Bridging the Healthcare Gap in Eastern India",
            hospital: "Dhamma Superspeciality Hospital, Patna",
            date: "Jun 22, 2026",
            category: "media-coverage",
            categoryLabel: "Media Coverage",
            ...
            image: "/images/media/media_1.png",
            content: [
                "NDTV Health aired a comprehensive feature on Dhamma Superspeciality Hospital, exploring how the hospital is transforming healthcare delivery in Eastern India. The feature included interviews with patients, doctors, and hospital leadership."
            ]
        },
        "ht-telemedicine-initiative": {
            ...
            image: "/images/media/media_2.png",
            content: [
                "Hindustan Times published a feature article highlighting Dhamma Superspeciality Hospital's telemedicine initiative that has successfully connected over 100 villages in Bihar with specialist healthcare consultations."
            ]
        },
        "dainik-bhaskar-cardiac-screening": {
            ...
            image: "/images/media/media_1.png",
            content: [
                "Dainik Bhaskar reported on Dhamma Superspeciality Hospital's free cardiac screening camp organized for underprivileged communities in the Gaya region. The camp screened over 300 individuals for heart disease risk factors."
            ]
        }
    },
    "newsletters": {
        "newsletter-june-2026": {
            ...
            subtitle: "Monthly highlights from Dhamma Superspeciality Hospital",
            image: "/images/media/media_2.png",
            content: [
        ...
        "research-digest-q2-2026": {
            ...
            image: "/images/media/media_1.png",
            content: [
                "The Q2 2026 Research Digest presents the latest research findings and clinical innovations from Dhamma Superspeciality Hospital. This quarter, our focus has been on advancing minimally invasive surgical techniques across multiple specialties."
            ]
        },
        "newsletter-may-2026": {
        ...
        "newsletter-april-2026": {
            ...
            image: "/images/media/media_1.png",
            content: [
                "In April 2026, Dhamma Superspeciality Hospital inaugurated its advanced cardiac catheterization laboratory, equipped with the latest biplane angiography system. This addition significantly enhances the hospital's capacity to perform complex cardiac interventions."
            ]
        }
    },
    "media-connect": {
        "national-conference-neurosurgery": {
            title: "Dhamma Superspeciality Hospital Hosts National Conference on Advances in Neurosurgery 2026",
            hospital: "Dhamma Superspeciality Hospital, Patna",
            date: "Jun 27, 2026",
        ...
        "mou-aiims-patna-oncology": {
            ...
            image: "/images/media/media_1.png",
            content: [
                "Dhamma Superspeciality Hospital and AIIMS Patna have signed a Memorandum of Understanding (MoU) for joint research collaboration in the fields of oncology and cancer care. The partnership aims to advance cancer treatment protocols and improve outcomes for patients in Bihar."
            ]
        },
                ...
                <div className="max-w-[800px] mx-auto px-6 lg:px-12">
                    ...
                    <div className="mt-10 pt-6 border-t border-gray-100">
                        <div className="flex flex-wrap gap-2">
                            {["Dhamma Superspeciality Hospital", "Bodhgaya", article.categoryLabel, "Healthcare", "Bihar"].map(tag => (
