        ...
        <div className="bg-white min-h-screen" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            ...
            <section className="relative w-full overflow-hidden" style={{ background: "linear-gradient(135deg, #003580 0%, #0057A8 55%, #0069CC 100%)" }}>
                ...
                <div className="relative max-w-[1200px] mx-auto px-6 lg:px-12 py-14 lg:py-20 text-center">
                    <p className="text-xs font-bold uppercase tracking-[3px] mb-3" style={{ color: "#F5BE00" }}>DHAMMA SUPERSPECIALITY HOSPITAL</p>
                    ...
                    <p className="text-base text-blue-100 max-w-xl mx-auto">Stay updated with the latest news, press releases, and media coverage from Dhamma Superspeciality Hospital.</p>
                </div>
            </section>
