...
const AboutOverview = () => {
    ...
    return (
        <div className="bg-white">
                    ...
                    <div className="max-w-4xl">
                        ...
                        >
                            ...
                            <p className="text-white/80 text-lg md:text-xl font-medium max-w-2xl leading-relaxed mb-10">
                                Dhamma Institute of Medical Sciences is a trusted healthcare destination in Patna, committed to delivering quality medical care with compassion and modern technology.
                            </p>
                    ...
                    <div className="flex flex-col lg:flex-row gap-20 items-center">
                        <div className="flex-1">
                            ...
                            <p className="text-slate-500 mb-8">
                                Dhamma Institute of Medical Sciences is built with a vision to become a leading healthcare institution in Bihar and Eastern India, combining advanced medical technology with experienced healthcare professionals.
                            </p>
                    ...
                    <div className="flex-1 bg-brandBlue text-white p-12 md:p-24 flex flex-col justify-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-white/70 text-lg mb-12 max-w-xl font-medium">
                                At Dhamma Institute of Medical Sciences, we believe healthcare should reach everyone. We actively bridge the gap in underserved areas through dedicated programs.
                            </p>
            ...
            {/* --- WHY CHOOSE Dhamma Institute of Medical Sciences (Premium Icon Grid) --- */}
            <section className="section-padding bg-brandBlue relative overflow-hidden">
                ...
                <div className="container-custom relative z-10">
                    <div className="text-center mb-20">
                        ...
                        <h2 className="section-heading-white">Why Choose Dhamma Institute of Medical Sciences?</h2>
                        ...
                        <div className="flex flex-col md:flex-row gap-16 items-start">
                            <div className="flex-1">
                                ...
                                <p className="text-slate-600 text-lg leading-relaxed mb-6 font-medium">
                                    Dhamma Institute of Medical Sciences is dedicated to redefining healthcare standards in the region by integrating modern medical practices with compassionate patient care. With a strong focus on quality, safety, and accessibility, Dhamma Institute of Medical Sciences ensures that every patient receives personalized attention and the best possible treatment.
                                </p>
            ...
            <section className="section-padding bg-brandSaffron overflow-hidden relative">
                ...
                <div className="container-custom relative z-10 text-center">
                    ...
                    <p className="text-white text-xl font-bold mb-12 uppercase tracking-[0.2em]">
                        Visit Dhamma Institute of Medical Sciences today and experience healthcare with care, trust, and excellence.
                    </p>
