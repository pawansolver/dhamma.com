        ...
        <div className="bg-[#0a0a0a] text-white overflow-x-hidden">
            ...
            <section className="relative min-h-[100dvh] pt-28 sm:pt-36 pb-12 sm:pb-20 flex flex-col justify-between overflow-hidden">
                ...
                <div className="absolute inset-0">
                    <Image src="/images/about-hospital.png" alt="Dhamma Institute of Medical Sciences" fill priority className="object-cover object-top" />
                    {/* Dark cinematic overlay — keeps Dhamma Institute of Medical Sciences branding visible but creates premium dark feel */}
                ...
                >
                    ...
                    <p className="text-amber-400 font-bold text-sm mt-3">— Chairman, Dhamma Institute of Medical Sciences</p>
                </motion.div>
            </section>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
                ...
                <div className="relative min-h-[500px] lg:min-h-0 overflow-hidden bg-[#111] group">
                    <Image
                        src="/chairman.jpg"
                        alt="Chairman — Dhamma Institute of Medical Sciences"
                        fill
                    ...
                    >
                        ...
                        <p className="text-white/50 text-xs mt-0.5">Dhamma Institute of Medical Sciences</p>
                    ...
                    <div className="relative z-10 max-w-lg">
                        <div className="flex items-start gap-3 mb-8">
                            ...
                            <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#1a1a1a]/50 leading-relaxed">
                                Dhamma Institute of Medical Sciences<br />A Message of Vision &amp; Purpose
                            </p>
                        </div>
                        ...
                        <div className="space-y-5 text-[#1a1a1a]/70 text-[15px] leading-relaxed">
                            <p>
                                At <strong className="text-[#1a1a1a]">Dhamma Institute of Medical Sciences</strong>, our journey began with a simple yet powerful vision — to make quality healthcare accessible, affordable, and trustworthy for every individual.
                            </p>
                            <p>
                        ...
                        <div className="mt-10 pt-8 border-t border-[#1a1a1a]/15">
                            ...
                            <p className="text-[#1a1a1a]/55 text-sm mt-1">Dhamma Institute of Medical Sciences</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-12 text-center">
                    <motion.div {...fadeUp()}>
                        ...
                        <h2 className="section-heading-white">
                            &ldquo;Healthcare is not just a service — it is a responsibility towards humanity. at Dhamma Institute of Medical Sciences, we honor that responsibility every day.&rdquo;
                        </h2>
                        <div className="flex items-center justify-center gap-4 mt-8">
                            <div className="w-12 h-px bg-amber-400/50" />
                            <p className="text-amber-400 font-bold text-sm uppercase tracking-widest">Chairman, Dhamma Institute of Medical Sciences</p>
                            <div className="w-12 h-px bg-amber-400/50" />
                        </div>
                    </motion.div>
                </div>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[560px]">
                ...
                <div className="relative min-h-[380px] lg:min-h-0 overflow-hidden group">
                    <Image src="/hospital_hero_hd.png" alt="Dhamma Institute of Medical Sciences" fill className="object-cover object-center group-hover:scale-105 transition duration-700" />
                ...
                <div className="bg-[#111] flex items-center px-10 lg:px-16 py-20 relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-lg">
                        ...
                        <p className="text-white/50 text-base leading-relaxed mb-8">
                            As Dhamma Institute of Medical Sciences continues to grow, we remain focused on building a center of excellence in healthcare and medical education — earning the trust of every patient and family through transparency, integrity, and compassionate service.
                        </p>
            ...
            <section className="relative bg-[#0a0a0a] py-20 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                    <motion.div {...fadeUp()} className="max-w-2xl">
                        <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-amber-400 mb-5 flex items-center gap-2">
                            <span className="w-5 h-px bg-amber-400" /> Visit Dhamma Institute of Medical Sciences
                        </p>
                        <h2 className="section-heading-white">
                            Experience care<br />built on trust.
                        </h2>
                        <p className="text-white/45 text-base leading-relaxed mb-10">
                            Come visit Dhamma Institute of Medical Sciences — a place where every patient is treated with the dignity, compassion, and clinical excellence they deserve.
                        </p>
