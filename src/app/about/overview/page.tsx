        ...
        <div className="bg-white text-gray-900 overflow-x-hidden pt-16">
            ...
            <div className="max-w-[1140px] mx-auto px-4 sm:px-6 pt-4 pb-6">
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-brandBlue mb-2">
                    About Dhamma Institute of Medical Sciences
                </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center">
                        ...
                        <div className="prose prose-gray text-gray-600 text-xs sm:text-sm leading-relaxed space-y-4 font-sans text-justify">
                            <p>
                                Dhamma Institute of Medical Sciences, situated at Phulwari Sharif, Patna, Bihar (Opposite Canara Bank, near AIIMS Gate No. 1), is a premier multi-speciality healthcare facility guiding patient care under the motto <strong className="text-brandBlue font-semibold">सेवा परमो धर्म:</strong> (Service is the highest duty).
                            </p>
                            <p>
            ...
            <section className="max-w-[1140px] mx-auto px-4 sm:px-6 py-8 lg:py-12 border-b border-gray-100">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center order-2 lg:order-1">
                        ...
                        <div className="prose prose-gray text-gray-600 text-xs sm:text-sm leading-relaxed space-y-4 font-sans text-justify">
                            <p>
                                Every staff member at Dhamma Institute of Medical Sciences is dedicated to giving high-quality, compassionate care. That includes thousands of families across Patna and rural Bihar who put their faith in our treatments each year.
                            </p>
                            <p>
            ...
            <section className="bg-gray-50 py-10 lg:py-14 border-b border-gray-100">
                <div className="max-w-[800px] mx-auto px-4 text-center">
                    ...
                    <p className="text-[10px] text-gray-500 uppercase tracking-widest">
                        Chairman &amp; Chief Director, Dhamma Institute of Medical Sciences
                    </p>
                </div>
            </section>
            ...
            <section className="bg-gray-50 border-t border-gray-100 py-10 sm:py-14">
                <div className="max-w-[700px] mx-auto px-4 text-center flex flex-col items-center">
                    ...
                    <p className="text-gray-600 text-xs sm:text-sm leading-relaxed mb-6 max-w-lg">
                        Visit Dhamma Institute of Medical Sciences — where elite medicine meets local empathy. Walk in or schedule a priority consultation online.
                    </p>
