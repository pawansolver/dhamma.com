...
const BLOG_DETAILS: Record<string, any> = {
  "fluttering-in-chest": {
    ...
    content: `
      ...
      <p>If your chest fluttering is accompanied by shortness of breath, dizziness, chest pain, or fainting, you should seek emergency medical care immediately at Dhamma Superspeciality Hospital.</p>
    `
  }
};
...
export default function BlogDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const blog = BLOG_DETAILS[slug] || {
    ...
    image: "/images/blogs/thumb.png",
    content: `
      <p>This is a detailed article discussing the various aspects of <strong>${slug.replace(/-/g, ' ')}</strong>. At Dhamma Superspeciality Hospital, we prioritize patient education and preventive healthcare.</p>
