...
import {
    ...
    Pill, Clock, Award, Users, CheckCircle, ChevronRight, Calendar,
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
                        ...
                        <div className="lg:col-span-7">
                            ...
                            <p className="text-gray-600 leading-relaxed text-[15px] mb-6">
                                At <strong>Dhamma Institute of Medical Sciences</strong>, our {department.badge} department combines advanced clinical expertise with cutting-edge technology. Our specialists are dedicated to delivering evidence-based, patient-centric care with compassion — rooted in our philosophy of <strong style={{ color: "#0057A8" }}>सेवा परमो धर्म:</strong>.
                            </p>
                        ...
                        {/* Right: Consistent department facts card */}
                        <div className="lg:col-span-5">
                            <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg">
                                <div className="px-6 py-5" style={{ background: "#0057A8" }}>
                                ...
                                <div className="grid grid-cols-2 gap-px bg-gray-200">
                                    {[
                                        { value: "500+", label: "OPD Daily" },
                                        { value: "100+", label: "Beds" },
                                        { value: "24/7", label: "Emergency Cover" },
                                        { value: "20+", label: "Faculty & Residents" },
                                    ].map((stat) => (
                                        <div key={stat.label} className="bg-white p-5 text-center">
                                            <p className="text-2xl font-black" style={{ color: "#0057A8" }}>
                                                {stat.value}
                                            </p>
            ...
            <section className="py-10" style={{ background: "linear-gradient(90deg, #CC2027, #a01820)" }}>
                <div className="max-w-[1200px] mx-auto px-6 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex gap-4">
                        ...
                        <a
                            href={`https://wa.me/917643990301?text=${encodeURIComponent('Hello! I would like to enquire about an appointment at Dhamma Institute of Medical Sciences. Please guide me.')}`}
                            target="_blank"
                            rel="noopener noreferrer"
