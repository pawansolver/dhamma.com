...
export const metadata: Metadata = {
  title: "Dhamma Institute of Medical Sciences | Patna, Bihar",
  description:
    "Dhamma Institute of Medical Sciences — Leading multi-speciality healthcare in Patna, Bihar. Expert doctors, advanced diagnostics, 24/7 emergency. सेवा परमो धर्म:",
  icons: {
    icon: "/logo.png",
  },
};
