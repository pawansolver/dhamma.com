                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-xl mx-auto mt-4 text-sm">
                            Locate Dhamma Institute of Medical Sciences in Patna. Browse campus captures and navigate using the interactive map interface below.
                        </p>
                    </div>
                        ...
                        <div className="lg:col-span-5 flex flex-col gap-6 justify-between">
                            ...
                            <div className="relative h-[240px] w-full rounded-[2.5rem] overflow-hidden shadow-md group bg-slate-100 border border-slate-100">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent flex flex-col justify-end p-6">
                                    ...
                                    <h4 className="text-white font-bold text-sm font-montserrat">Dhamma Institute of Medical Sciences Entrance</h4>
                        ...
                        <div className="lg:col-span-7 bg-slate-50 border border-slate-150 p-6 rounded-[3rem] shadow-sm flex flex-col justify-between min-h-[480px]">
                            <div>
                                ...
                                <p className="text-slate-500 text-xs leading-relaxed mb-6">
                                    Dhamma Institute of Medical Sciences is prominently situated **Opposite Canara Bank, Phulwari Sharif, Near AIIMS Gate No. 1, Patna, India, Bihar**. Use the live interactive map directions for seamless transit.
                                </p>
                            </div>
