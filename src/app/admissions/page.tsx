...
const counselingSteps: Record<StepKey, CounselingStep> = {
    ...
    choice: {
        ...
        desc: "Eligible UGMAC candidates must log in to the official Bihar Combined Entrance Competitive Examination Board portal and select Dhamma Institute of Medical Sciences Patna as their high priority preference.",
        instructions: [
            "Log in to bceceboard.bihar.gov.in during choice schedule",
            "Lock 'Dhamma Institute of Medical Sciences' as primary medical seat choice",
    ...
    allotment: {
        ...
        desc: "BCECEB publishes round-wise provisional seat allotment results. Candidates allotted a seat at Dhamma Institute of Medical Sciences must download their official allotment letters.",
        instructions: [
    ...
    reporting: {
        ...
        desc: "Report directly to the Dhamma Institute of Medical Sciences Patna admission cell with original academic certificates, allotment letters, biometric forms, and tuition fee drafts.",
        instructions: [
...
export default function AdmissionsPage() {
    ...
    const documentsChecklist = [
        ...
        "Medical Fitness Certificate (Can be obtained at Dhamma Institute of Medical Sciences Campus)"
    ];
            ...
            <section className="relative h-[65vh] min-h-[500px] flex items-center justify-center overflow-hidden bg-slate-950 text-white">
                ...
                <div className="relative z-20 text-center px-6 max-w-4xl mx-auto -mt-6">
                    ...
                    <p className="text-lg lg:text-xl text-blue-100 font-medium mb-10 leading-relaxed max-w-2xl mx-auto opacity-95">
                        Follow the structured NEET-UG counselling pathway, verify fees details, and pack standard dossiers for physical reporting at Dhamma Institute of Medical Sciences.
                    </p>
                    <button
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white p-6 sm:p-8 lg:p-12 rounded-3xl sm:rounded-[3rem] border border-slate-200/80 shadow-xl max-w-2xl mx-auto relative overflow-hidden">
                        ...
                        <div className="bg-slate-950 text-white p-6 rounded-2xl text-center shadow-lg">
                            ...
                            <p className="text-[8px] text-slate-400 uppercase tracking-wider mt-1">Drawn in favor of Dhamma Institute of Medical Sciences, payable at Patna</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div>
                            ...
                            <div className="space-y-4 mb-8 text-xs text-slate-300">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span>Dhamma Institute of Medical Sciences Admissions Desk, Opposite Canara Bank, Phulwari Sharif, Near AIIMS Gate No. 1, Patna, India, Bihar</span>
                                </div>
                            </div>
                        </div>
