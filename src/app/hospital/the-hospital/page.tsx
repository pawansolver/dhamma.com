...
export default function HospitalPage() {
    ...
    const faqs = [
        { q: "What kind of hospital Is Dhamma Institute of Medical Sciences?", a: "Dhamma Institute of Medical Sciences is a modern multi-speciality hospital and research institute providing comprehensive healthcare services from outpatient consultation to advanced critical care, surgery, and diagnostics — all under one roof in Patna, Bihar." },
        { q: "Does Dhamma Institute of Medical Sciences offer 24/7 emergency services?", a: "Yes. Our emergency department operates 24×7 with dedicated trauma care, ambulance support, and rapid response teams to handle critical medical situations at any hour." },
        { q: "What specialities are available?", a: "Dhamma Institute of Medical Sciences covers 20+ medical specialities including General Medicine, Surgery, Cardiology, Orthopaedics, Paediatrics, Obstetrics & Gynaecology, ENT, Ophthalmology, Psychiatry, Radiology, and many more." },
        ...
        { q: "Does Dhamma Institute of Medical Sciences have insurance cashless tie-ups?", a: "Yes. We have cashless tie-ups with major insurance providers and TPAs. Patients can avail cashless treatment after pre-authorisation through our insurance desk." },
    ];
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
                    <motion.div {...fadeUp()} className="flex items-start gap-3 mb-10">
                        ...
                        <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#1a1a1a]/60 max-w-xs leading-relaxed">
                            Dhamma Institute of Medical Sciences<br />Where care begins, healing follows.
                        </p>
                    </motion.div>
                ...
                <div className="bg-[#d6cdb8] flex items-center px-10 lg:px-16 py-20 relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-lg">
                        ...
                        <p className="text-[#1a1a1a]/65 text-base leading-relaxed mb-10 max-w-md">
                            Healthcare shouldn&apos;t be limited by income, location, or time. Dhamma Institute of Medical Sciences exists to bring world-class clinical care into the hands of every family in Bihar.
                        </p>
                        <Link
                            href="/contact"
