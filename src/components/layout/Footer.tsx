        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-10">
          ...
          {[
            ...
            <div key={colIdx} className="space-y-0.5">
              <h3 className="text-[15px] font-bold text-amber-400 mb-3 italic">
          ...
          <div>
            ...
            <ul className="space-y-2.5 mb-4">
              <li className="flex items-start gap-2 text-xs text-white/60">
                <MapPin size={14} className="mt-0.5 flex-shrink-0 text-amber-400" />
              ...
              <li className="flex items-center gap-2 text-xs text-white/60">
                <Mail size={14} className="flex-shrink-0 text-amber-400" />
                <a href="mailto:bhribodhgaya@gmail.com" className="hover:text-white transition">bhribodhgaya@gmail.com</a>
              </li>
              <li className="flex items-center gap-2 text-xs text-white/60">
                <Phone size={14} className="flex-shrink-0 text-amber-400" />
