  ...
  return (
    <div className="bg-brandBlueDark border-t-2 border-brandSaffron">
      <div className="flex items-stretch">
        ...
        {/* Ticker area */}
        <div className="flex-1 overflow-hidden flex items-center bg-brandBlueDark px-2 sm:px-3">
          <div className="whitespace-nowrap animate-marquee flex items-center gap-4 sm:gap-6 text-white text-[11px] sm:text-xs font-medium">
