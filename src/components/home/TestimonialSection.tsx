...
const testimonials = [
  {
    rating: 5.0,
    text: "I am deeply grateful for the exceptional support provided by Dhamma Superspeciality Hospital. With their seamless coordination, I was able to connect with the best doctors for a virtual second opinion consultation. The doctor's expertise and compassionate approach gave me clarity and confidence in my treatment journey. The entire experience from booking to consultation was smooth and reassuring. Thank you for bridging the gap and making world-class healthcare accessible.",
