  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="hidden lg:flex fixed left-0 top-1/2 -translate-y-1/2 z-40 flex-col gap-2">
        <a href="https://www.facebook.com/buddhahospitalandresearch" aria-label="Facebook" className="w-10 h-10 flex items-center justify-center bg-[#1877f2] text-white rounded-r-lg hover:scale-110 transition shadow-lg">
        ...
        <a href="https://www.instagram.com/buddha_hospital_gaya" aria-label="Instagram" className="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] text-white rounded-r-lg hover:scale-110 transition shadow-lg">
