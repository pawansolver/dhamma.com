              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 flex items-end justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <Image src="/logo.png" alt="Dhamma Institute of Medical Sciences" width={28} height={28} className="rounded-full" />
                    <span className="text-white/80 text-xs font-semibold">Dhamma Institute of Medical Sciences, Patna</span>
                  </div>
