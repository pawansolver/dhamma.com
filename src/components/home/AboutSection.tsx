    ...
    <section className="section bg-bgLight">
      <div className="container-custom flex flex-col lg:flex-row items-center gap-10">
        <div className="flex-shrink-0 relative">
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden shadow-2xl border-4 border-brandGreen/30">
            {/* Top gradient fill */}
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-textmain/80 text-base leading-relaxed mb-6 text-justify">
            Our doctors are assisted by a team of devoted nurses and paramedics. We have 24 x 7
          ...
          <SparkleButton href="/about">Read More</SparkleButton>
        </div>
      </div>
    </section>
  );
