...
export const SparkleButton = ({
  ...
  const modifiedOptions = useMemo(() => {
    const opts = { ...options, autoPlay: isHovering };
    return opts;
  }, [isHovering]);

  const outerClass = cn(
    "group relative rounded-full bg-gradient-to-r from-blue-300/30 via-blue-500/30 via-40% to-purple-500/30 p-1 text-white transition-transform hover:scale-110 active:scale-105 inline-flex",
    className
  );

  const inner = (
    <>
      <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-300 via-blue-500 via-40% to-purple-500 px-5 py-2.5 text-white">
...
export { SparkleButton as Component };
